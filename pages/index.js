  ...
  async function handleUpdateContact(data) {
    ...
    try {
      API.graphql({
        ...
        newContacts.push(data.data.updateContact);
          ...
          <main className="min-w-0 flex-1 border-t border-gray-200 lg:flex">
            ...
            <aside className="hidden lg:order-first lg:block lg:flex-shrink-0">
              <div className="relative flex h-full w-96 flex-col overflow-y-auto border-r border-gray-200 bg-gray-100">
                <button
                  className="inline-flex w-full justify-center rounded-md border border-transparent bg-indigo-500 px-4 py-2 my-3 text-base font-medium text-white shadow-sm hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
